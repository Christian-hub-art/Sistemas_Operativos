...
#include <stdlib.h>
#include <sys/time.h>
//se incluye modulo.h para incluir la programacion modular
#include "modulo.h"

// funcion para tomar tiempo inicial
void InicioMuestra(){
	//se usa una funcion de la libreria tiempo 
	gettimeofday(&ini, (void *)0);
};

//Funcion para tomar tiempo final y representa el resultado en ms 
void FinMuestra(){
